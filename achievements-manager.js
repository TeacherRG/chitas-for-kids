...
class AchievementsManager {
     ...
     *
     * Эта функция автоматически вызывается после загрузки данных и:
     ...
     *
     * ВАЖНО: Вызывается БЕЗ await в init() чтобы не блокировать авторизацию!
     */
    async recalculateStreaksOnce() {
        ...
        try {
            ...
            await this.syncToFirebase(true); // Тихая синхронизация
